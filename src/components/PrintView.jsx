              ...
              <div key={project.id} className="border border-slate-300 rounded-xl p-5 bg-white shadow-none break-inside-avoid">
                ...
                <div className="space-y-3 text-xs leading-relaxed text-justify text-slate-800">
                  ...
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 text-slate-700 mt-2 font-mono text-[11px] space-y-1">
                    ...
                    <p>• File Báo cáo (PDF): <span className={project.report === "Sẽ cập nhật sau" ? "text-amber-600 font-bold" : "text-academic-blue font-bold break-all"}>{project.report || "Sẽ cập nhật sau"}</span></p>
                    <p>• Ảnh chụp màn hình: <span className={project.evidenceImg === "Sẽ cập nhật sau" ? "text-amber-600 font-bold" : "text-academic-blue font-bold break-all"}>{project.evidenceImg || "Sẽ cập nhật sau"}</span></p>
