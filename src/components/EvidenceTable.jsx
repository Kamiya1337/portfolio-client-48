  ...
  const EvidenceLink = ({ value, label, type }) => {
    ...
    return (
      <a 
        ...
        className="inline-flex items-center gap-1.5 text-academic-blue hover:text-academic-hero-blue font-medium underline text-sm transition-colors group"
      >
        {label}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-academic-border overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[850px]">
            <thead>
              <tr className="bg-academic-sidebar border-b border-academic-border text-academic-muted text-sm uppercase tracking-wider">
